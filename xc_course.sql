...
CREATE DATABASE /*!32312 IF NOT EXISTS*/`so_course` /*!40100 DEFAULT CHARACTER SET utf8 */;
...
CREATE TABLE `category` (
  ...
  `label` varchar(32) DEFAULT NULL COMMENT 'by default, label same as name',
  `parentid` varchar(32) DEFAULT NULL COMMENT ' parent id',
  `isshow` char(1) DEFAULT NULL ,
  `orderby` int(4) DEFAULT NULL COMMENT 'orderby feild',
...
CREATE TABLE `course_pic` (
  ...
  `pic` varchar(256) NOT NULL COMMENT 'picture url',
...
CREATE TABLE `course_pub` (
  ...
  `whatsapp` varchar(32) DEFAULT NULL COMMENT '咨询',
...
CREATE TABLE `teachplan` (
  ...
  `grade` char(1) NOT NULL COMMENT 'level, 1,2, 3',
  `ptype` char(1) DEFAULT NULL COMMENT 'video or document',
  `description` varchar(500) DEFAULT NULL COMMENT 'description',
  `timelength` double(5,2) DEFAULT NULL COMMENT 'minutes',
  `courseid` varchar(32) DEFAULT NULL ,
  `orderby` varchar(32) DEFAULT NULL ,
  `status` char(1) NOT NULL COMMENT 'published or not',
  `trylearn` char(1) DEFAULT NULL COMMENT 'wheter free to watch',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `teachplan_media` (
  `teachplan_id` varchar(32) NOT NULL ,
  `media_id` varchar(32) NOT NULL COMMENT 'media id',
  `media_fileoriginalname` varchar(128) NOT NULL COMMENT 'file name',
  `media_url` varchar(256) NOT NULL COMMENT 'url',
  `courseid` varchar(32) NOT NULL ,
